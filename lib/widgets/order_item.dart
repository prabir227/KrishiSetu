import 'package:krishi_setu/models/order.dart';
...
class OrderItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
     ...
     children: [
    Text(
      "Order: ₹${order.id}",  // Corrected string interpolation
    ...
    const Spacer(),
    Text(
      "(${order.products.length} Items)",  // Corrected string interpolation
      style: theme.textTheme.bodySmall,
    ),
    const SizedBox(width: 5),
    Text(
      "₹${totalPrice.toStringAsFixed(2)}",  // Added rupee sign here
