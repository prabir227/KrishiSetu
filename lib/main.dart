        ...
        child: Column(
          ...
          children: [
              ...
              child: Row(
                ...
                children: fCheck
                  ...
                  Icon(
                    ...
                    : <Widget>[
                  Text("Farmer", style: TextStyle(fontSize: 20, color: Colors.grey)) // Gray text when Farmer is not selected
                ],
              ),
              flex: 50,
            ),
              ...
              child: Row(
                ...
                children: cCheck
                  ...
                  Icon(
                    ...
                    : <Widget>[
                  Text("Contractor", style: TextStyle(fontSize: 20, color: Colors.grey)) // Gray text when Contractor is not selected
                ],
              ),
              flex: 50,
            ),
            ...
            Expanded(
              child: pageRoute <= 0
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => LoginPage(user: pageRoute)),
                  );
                },
                child: Text(
                  "NEXT",
              ...
              flex: 63, // Corrected positioning of flex
            ),
            Expanded(
